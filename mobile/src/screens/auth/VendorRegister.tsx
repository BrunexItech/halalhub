...
const VendorRegister = () => {
  ...
  const businessTypes = [
    { id: 'halalmarket', name: 'Halal Market' },
    { id: 'halalbutchery', name: 'Halal Butchery' },
    { id: 'restaurant', name: 'Restaurant' },
    { id: 'halalstay', name: 'HalalStay' },
    { id: 'hearse', name: 'Hearse & Shroud Provider' },
    { id: 'hajj', name: 'Hajj & Umrah Package Provider' },
  ];
  ...
  const handleNext = () => {
    ...
    if (step === 1 && (!formData.businessName || !formData.businessType || !formData.region || !formData.subCounty || !formData.ward)) {
    ...
    switch (step) {
        ...
        return (
          <View style={{ marginTop: 4 }}>
            <View style={{ marginBottom: 12 }}>
              <Text style={{ color: '#F7F6F1', fontSize: 16, fontWeight: '700' }}>Business Information</Text>
              <Text style={{ color: '#6B7280', fontSize: 12 }}>Tell us about your business</Text>
            </View>
            ...
            >
              <Text style={{
                color: formData.businessType ? '#F7F6F1' : '#6B7280',
                fontSize: 14,
              }}>
                {formData.businessType ? businessTypes.find(t => t.id === formData.businessType)?.name : 'Select Business Type *'}
              </Text>
              <Text style={{ color: '#C9A44B', fontSize: 16 }}>▼</Text>
            </TouchableOpacity>
        ...
        return (
          <View style={{ marginTop: 4 }}>
            <View style={{ marginBottom: 12 }}>
              ...
              <Text style={{ color: '#6B7280', fontSize: 12 }}>Create your account PIN</Text>
            </View>
      ...
      case 5:
        return (
          <View style={{ marginTop: 4 }}>
            <View style={{ marginBottom: 12 }}>
              <Text style={{ color: '#F7F6F1', fontSize: 16, fontWeight: '700' }}>Halal Compliance</Text>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleChange('halalDeclared', !formData.halalDeclared)}
            >
              <View style={{
                width: 20,
                height: 20,
                borderRadius: 4,
                borderWidth: 2,
                borderColor: formData.halalDeclared ? '#C9A44B' : 'rgba(201, 164, 75, 0.3)',
                backgroundColor: formData.halalDeclared ? '#C9A44B' : 'transparent',
                alignItems: 'center',
                justifyContent: 'center',
                marginRight: 12,
              }}>
                {formData.halalDeclared && (
                  <Text style={{ color: '#032A24', fontSize: 12, fontWeight: '700' }}>✓</Text>
                )}
              </View>
              <Text style={{ color: '#F7F6F1', fontSize: 13, flex: 1 }}>
                I declare my business is Sharia-compliant
              </Text>
            </TouchableOpacity>
          ...
          <View style={{ alignItems: 'center', paddingVertical: 24 }}>
            ...
            <View style={{
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 }}>
                <Text style={{ color: '#6B7280', fontSize: 12 }}>Business:</Text>
                <Text style={{ color: '#F7F6F1', fontSize: 12, fontWeight: '500' }}>{formData.businessName}</Text>
              </View>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 }}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 4 }}>
                <Text style={{ color: '#6B7280', fontSize: 12 }}>County:</Text>
                <Text style={{ color: '#F7F6F1', fontSize: 12, fontWeight: '500' }}>{formData.regionName}</Text>
              </View>
            </View>
            <TouchableOpacity
              style={{
