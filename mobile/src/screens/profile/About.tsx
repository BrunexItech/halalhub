...
const BuildingIcon = ({ color = '#032A24', size = 18 }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Rect x="4" y="8" width="16" height="12" rx="1" stroke={color} strokeWidth="1.5"/>
    <Path d="M8 4H16V8H8V4Z" stroke={color} strokeWidth="1.5" strokeLinejoin="round"/>
      ...
      >
        <View style={{ maxWidth: 800, width: '100%', alignSelf: 'center' }}>
          ...
          <View style={{
            ...
            paddingBottom: 16,
            borderBottomWidth: 1,
            borderBottomColor: 'rgba(3, 42, 36, 0.06)',
          }}>
            <TouchableOpacity
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 14, marginBottom: 28 }}>
            {[
              { icon: ShieldIcon, title: 'Mission', desc: 'To build technology that respects Islamic values, connects communities, and makes essential services more accessible to Muslims everywhere.' },
              { icon: TargetIcon, title: 'Vision', desc: 'A world where Muslims can access trusted, meaningful, and Sharia-conscious digital services through one connected ecosystem.' },
              { icon: HeartIcon, title: 'Purpose', desc: 'Technology is the tool. The purpose is to make meaningful services more accessible, transparent, and connected for the Muslim community.' },
            ].map((item, index) => (
            ...
            <View style={{
              ...
              {ecosystemServices.map((service, index) => (
                <View key={index} style={{
                  ...
                  padding: 12,
                  borderWidth: 1,
                  borderColor: 'rgba(201, 164, 75, 0.04)',
                  alignItems: 'center',
                  shadowColor: '#032A24',
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 12 }}>
              {[
                {
                  title: 'Not a Generic Platform',
                  desc: 'Itqaan is designed around the needs and values of the Muslim community from the beginning — not a generic platform with Islamic features added later.',
                },
                {
                  title: 'Connected Ecosystem',
                  desc: 'Unlike disconnected services, Itqaan brings financial tools, charitable solutions, travel services, and everyday digital experiences into one trusted platform.',
                },
              ].map((item, index) => (
                <View key={index} style={{
                  flex: 1,
