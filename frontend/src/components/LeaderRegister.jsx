          ...
          <div className="w-full max-w-sm mx-auto relative z-10">
            ...
            {step === 5 && (
              <div className="flex gap-2.5 mt-5">
                ...
                <button
                  className="flex-[2] px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#C9A44B] to-[#E1C16B] text-[#032A24] font-semibold text-xs shadow-md shadow-[#C9A44B]/20 hover:shadow-lg hover:shadow-[#C9A44B]/30 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] h-[42px]"
                  onClick={handleNext}
                >
                  Submit Application
                </button>
